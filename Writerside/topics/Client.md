...
After selecting the option "klanten" in the admin console, you will see a list of clients and their projects. On this
page you will be able to create a client or set existing clients and projects to active/inactive.
...
At the overview you can see how many projects are assigned to this client as well as how many of them are active. 
You can also see the status of the client on the right side of the table.
...
To modify a client or a project you can click on the client and click on a pencil for the information you want to change.
...
In the following picture you can see the process of deleting a process, this is the same for deleting a client but that is done in the "klanten" tab
![Delete project](MSS_Delete_Project.jpg)
